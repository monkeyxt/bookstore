...
- Another possible extention would be inplementing some kind of cache replacement algorithms for the frontend cache like LRU so that for a limited amount of cache memory, we can optimize the cache hit frequency. 
