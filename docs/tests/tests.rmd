...
```
\noindent The first `grep` command returns 200 and second returns 100. Thus the program works as designed to handle concurrent requests. For other tests, see the performance evaluation section.
