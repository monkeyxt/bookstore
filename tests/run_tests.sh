...
# Cache Hits Test 2
echo "Running Cache Hits Test 2"
for i in {1..100}
  do
...
# Cache Hits Test 3
echo "Running Cache Hits Test 3"
for i in {1..100}
  do
...
# Cache Hits Test 4
echo "Running Cache Hits Test 4"
for i in {1..100}
  do
...
# Sequential Test With Cache
echo "Cache: 100 sequential request for search operation"
python3 client.py search systems 100 c1
python3 client.py search gradschool 100 c1

echo "Cache: 100 sequential request for lookup operation"
...
echo "Cache: 100 sequential request for buy operation"
...
echo "No Cache: 100 sequential request for lookup operation"
python3 client.py lookup 1 100 c1
python3 client.py lookup 2 100 c1
python3 client.py lookup 3 100 c1
python3 client.py lookup 4 100 c1
...
echo "No Cache: 100 sequential request for buy operation"
python3 client.py buy 1 100 c1
python3 client.py buy 2 100 c1
python3 client.py buy 3 100 c1
python3 client.py buy 4 100 c1
